#> transfer_pet_owner:app/load_message
# Called on load

execute if score &transfer_pet_owner_load_message jodek.config matches 1 run tellraw @a [\
  {\
    "text": "[",\
    "color": "#aaaaaa"\
  },\
  {\
    ...
    "hover_event": {\
      ...
      "value": [\
        {\
          "nbt":"tellraw[]",\
          "storage": "transfer_pet_owner:image",\
          interpret: true,\
          separator: ""\
        }\
      ]\
